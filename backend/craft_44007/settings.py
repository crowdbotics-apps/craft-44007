"""
Django settings for craft_44007 project.
...
WSGI_APPLICATION = 'craft_44007.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "craft_44007 API",
    "DESCRIPTION": "API documentation for craft_44007 App",
    "VERSION": "v1",
}
